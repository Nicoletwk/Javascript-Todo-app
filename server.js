...
async function go() {
  let client = new MongoClient("mongodb+srv://nicolemongo:Artchy0422@cluster0.7k32xfg.mongodb.net/ToDoApp?retryWrites=true&w=majority")
...
function passwordProtected(req, res, next){
  ...
  //hello 123456
  if(req.headers.authorization == "Basic aGVsbG86MTIzNDU2"){
      next()
  } else {
